...
download_dataset_task >> format_to_parquet_task >> local_to_gcs_task >> bigquery_external_table_task >> [delete_dataset_csv_task, delete_dataset_parquet_task]